...
using ArchitectureAspNetCoreEF.Core.Domain.Repositories;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using System.Threading.Tasks;

namespace ArchitectureAspNetCoreEF.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public IActionResult Criar([Bind("Id,Marca,Modelo,Cor,AnoModelo,AnoFabricacao")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Editar(int id, [Bind("Id,Marca,Modelo,Cor,AnoModelo,AnoFabricacao")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
